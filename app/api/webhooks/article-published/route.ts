...
<!-- BAŞLIK -->
<h2 style="margin:0 0 12px;font-size:23px;font-weight:800;color:#f0f0f0;line-height:1.3;letter-spacing:-0.3px;">
${article.title}
</h2>

<!-- AÇIKLAMA -->
<p style="margin:0 0 26px;font-size:15px;color:#8a8a8a;line-height:1.7;">
