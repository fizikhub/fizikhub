...
export default function PaylasPage() {
    ...
    return (
        <div className="min-h-screen bg-background pb-24 pt-4 md:pt-20 px-4 font-sans relative overflow-hidden">
            ...
            {/* TEXTURED PAPER BACKGROUND - MAX BOOST for Mobile Visibility */}
            <div className="absolute inset-0 opacity-[0.8] dark:opacity-50 pointer-events-none z-0 mix-blend-multiply dark:mix-blend-overlay"
                style={{
                    // Even larger grain (0.4) for clear visibility on retina screens
                    backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noiseFilter'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.4' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noiseFilter)' opacity='0.8'/%3E%3C/svg%3E")`,
                }}
            ></div>
