      ...
      <body className={`${inter.variable} ${spaceGrotesk.variable} ${rubikGlitch.variable} font-sans min-h-[100dvh] flex flex-col pb-16 md:pb-0 bg-background text-foreground`}>
        ...
        >
          ...
          <Toaster
            position="top-center"
            toastOptions={{
              className: "font-sans border-2 border-white bg-black text-white shadow-[4px_4px_0px_0px_#ffffff] rounded-lg px-6 py-4 flex items-center justify-center text-center font-bold tracking-tight",
              style: {
                borderRadius: "8px",
                background: "#000000",
                color: "#ffffff",
