...
import { NexusGrid } from "@/components/home/nexus-grid";
import { NexusHero } from "@/components/home/nexus-hero";
...
export default async function Home() {
  ...
  // Split into "Featured" vs "Grid" is handled inside NexusGrid mostly, 
  // but we pass the raw sorted list.
  ...
  return (
    <main className="min-h-screen bg-background relative selection:bg-emerald-500/30">
      ...
      <div className="container max-w-7xl mx-auto px-4 md:px-6 relative z-10 pt-4 lg:pt-8">
        ...
        {/* The Knowledge Nexus Grid */}
        <NexusGrid items={feedItems} suggestedUsers={suggestedUsers} />
