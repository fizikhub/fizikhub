...
import { NeuroEvolutionSim } from "@/components/simulations/EvolutionarySimulation/NeuroEvolutionSim";
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-xl font-black uppercase italic tracking-tighter text-white">
                                NEURO-CENTIPEDE <span className="text-cyan-400">V4</span>
                            </h1>
                            <p className="text-[9px] font-bold uppercase tracking-widest text-cyan-400/50">
                                Artificial Intelligence & Neuroevolution Lab
                            </p>
                        </div>
                    </div>
                </div>
