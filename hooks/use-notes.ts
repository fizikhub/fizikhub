...
export const NOTE_COLORS: Record<NoteColor, { bg: string; border: string; label: string }> = {
    default: { bg: "bg-amber-50", border: "border-amber-300", label: "Varsayılan" },
    red: { bg: "bg-red-100", border: "border-red-400", label: "Kırmızı" },
    orange: { bg: "bg-orange-100", border: "border-orange-400", label: "Turuncu" },
    yellow: { bg: "bg-yellow-100", border: "border-yellow-400", label: "Sarı" },
    green: { bg: "bg-green-100", border: "border-green-400", label: "Yeşil" },
    blue: { bg: "bg-blue-100", border: "border-blue-400", label: "Mavi" },
    purple: { bg: "bg-purple-100", border: "border-purple-400", label: "Mor" },
};
