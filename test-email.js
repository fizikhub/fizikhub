...
const coverImage = 'https://images.unsplash.com/photo-1635070041078-e363dbe005cb?q=80&w=1000';
const articleUrl = 'https://www.fizikhub.com/makale/test';
const article = { title: 'Kuantum Mekaniği ve Schrödinger Denklemi', excerpt: 'Kuantum mekaniğinin temel taşlarından biri olan Schrödinger denklemi, atomaltı parçacıkların davranışını açıklar. Dalga fonksiyonunun fiziksel anlamını keşfedin.' };
...
<!-- İÇERİK -->
<tr>
<td class="bg-card" style="padding:20px 26px 30px;background-color:#1a1a1a;">
...
resend.emails.send({
  ...
  subject: "TEST 5: " + article.title,
  html: html,
}).then(r => console.log('OK', r.data)).catch(e => console.error('ERR', e));
