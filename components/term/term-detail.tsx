    ...
    return (
        <div className="min-h-screen bg-background relative overflow-hidden">
            ...
            <div className="container max-w-4xl mx-auto px-4 py-8 sm:py-16 relative z-10">
                ...
                {/* Back Button */}
                <Link prefetch={true} href="/blog?category=Terim" className="inline-flex items-center gap-2 text-muted-foreground hover:text-foreground mb-8 sm:mb-12 transition-colors group">
