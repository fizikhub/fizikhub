        ...
        <div className="space-y-2">
            ...
            <Tabs defaultValue="write" className="w-full">
                <TabsList className="grid w-full grid-cols-2 border-[3px] border-black p-0 h-10 rounded-[4px] bg-neutral-100 dark:bg-zinc-900 overflow-hidden mb-2 shadow-[2px_2px_0_0_#000]">
                    <TabsTrigger value="write" className="data-[state=active]:bg-[#EAB308] data-[state=active]:text-black data-[state=active]:font-black text-black dark:text-white font-bold h-full rounded-none">Yaz</TabsTrigger>
                    <TabsTrigger value="preview" className="data-[state=active]:bg-[#EAB308] data-[state=active]:text-black data-[state=active]:font-black text-black dark:text-white font-bold h-full border-l-[3px] border-black rounded-none">Önizle</TabsTrigger>
                </TabsList>
                <TabsContent value="write" className="flex flex-col gap-2">
                    ...
                    <div className="flex items-center gap-2 overflow-x-auto pb-1 scrollbar-hide w-full px-1">
                        ...
                        <button type="button" onClick={() => insertFormat("$$", "$$")} className="shrink-0 p-2 border-[2px] border-black rounded-[4px] bg-[#EAB308] text-black shadow-[2px_2px_0_0_#000] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none transition-all" title="LaTeX formülü">
