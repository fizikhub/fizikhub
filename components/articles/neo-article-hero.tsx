        ...
        <div className="w-full mb-8 sm:mb-16 relative overflow-hidden">
            ...
            <div className="container max-w-4xl mx-auto px-4 pt-6 sm:pt-12">
                ...
                <div className="flex items-center justify-between mb-6 sm:mb-10">
                    <Link  href="/makale" className="group flex items-center gap-2 sm:gap-3 text-xs sm:text-sm font-black uppercase tracking-widest text-foreground hover:-translate-y-1 transition-transform active:translate-y-0">
