...
export function MarsEffect() {
    ...
    return (
        <>
            {/* Mars Background Image Layer */}
            <div 
                className="fixed inset-0 pointer-events-none z-[-1]"
                style={{
                    backgroundImage: `url('/images/mars-bg.png')`,
            ...
            />
            {/* Mars Surface Glow Overlay */}
            <div 
                className="fixed inset-0 pointer-events-none z-[-1]"
                style={{
                    background: `radial-gradient(ellipse at bottom, rgba(234, 88, 12, 0.15) 0%, transparent 60%)`,
                }}
            />
            {/* Dust Particles */}
