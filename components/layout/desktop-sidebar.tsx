...
import { Home, BookOpen, Atom, Trophy, Book, Zap, Plus, User, LogIn, MessageCircle, Search, Tags, Sparkles } from "lucide-react";
...
const menuItems = [
    ...
    { href: '/copilot', label: 'Copilot', icon: Sparkles, override: 'Copilot' },
