        ...
        <Sheet open={open} onOpenChange={setOpen}>
            <SheetTrigger asChild>
                <button
                    ...
                    className="no-min-size w-10 h-10 box-border p-0 flex items-center justify-center bg-[#27272a] border-[3px] border-black shadow-[3px_3px_0px_0px_#000] hover:shadow-[1px_1px_0px_0px_#000] hover:translate-x-[1px] hover:translate-y-[1px] active:shadow-none active:translate-x-[3px] active:translate-y-[3px] transition-all rounded-xl group"
                >
                    <Menu className="w-5 h-5 text-white stroke-[3] group-hover:scale-110 transition-transform" />
                </button>
            </SheetTrigger>
