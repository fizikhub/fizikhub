...
export function QuestionOfTheWeek({ questionId, questionSlug }: QuestionOfTheWeekProps) {
    ...
    return (
        ...
        >
            <div className="relative overflow-hidden group transition-all duration-200 bg-card border-2 border-black dark:border-white rounded-lg shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)]">
                {/* Lab Grid Background */}
