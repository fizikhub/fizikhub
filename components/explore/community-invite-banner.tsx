        ...
        <div className="group relative overflow-hidden rounded-xl border-2 border-black bg-[#86efac] shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-1px] hover:translate-y-[-1px] hover:shadow-[5px_5px_0px_0px_rgba(0,0,0,1)] transition-all duration-200">
            ...
            <div className="p-4 flex items-center gap-4">
                ...
                <div className="shrink-0 hidden sm:block">
                    <Link
                        ...
                        className={cn(
                            ...
                            "bg-black text-[#86efac] font-black uppercase tracking-wide text-xs",
                ...
                <div className="shrink-0 sm:hidden">
                    <Link
                        href="/yazar/rehber"
                        className="w-10 h-10 bg-black text-[#86efac] rounded-lg flex items-center justify-center border-2 border-transparent hover:bg-primary hover:text-black hover:border-black transition-colors"
                    >
