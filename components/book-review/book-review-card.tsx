    ...
    return (
        <Link href={`/makale/${article.slug}`} className="block group font-sans">
            <article className={cn(
                ...
                <div className="absolute top-0 right-8 w-8 h-12 bg-primary shadow-md z-20 flex flex-col items-center justify-end pb-1 clip-path-ribbon transition-transform duration-300 group-hover:-translate-y-1">
                </div>
                <style jsx>{`
                    .clip-path-ribbon {
                ...
                <div className="relative w-32 sm:w-40 md:w-56 h-auto shrink-0 bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-900 dark:to-slate-950 flex items-center justify-center p-3 md:p-6 overflow-hidden border-r border-border/50">
                    ...
                    <div className="relative shadow-2xl rounded-[2px] overflow-hidden w-20 sm:w-24 md:w-36 aspect-[2/3] transition-all duration-500 will-change-transform group-hover:scale-105 group-hover:-rotate-2 group-hover:shadow-amber-900/20 [perspective:1000px]">
                        {article.cover_url ? (
                            <img
                            ...
                            <div className="w-full h-full bg-amber-900 flex flex-col items-center justify-center p-4 text-center text-amber-100 border-l-2 border-white/10">
                ...
                {/* Content Section */}
                <div className="flex-1 p-4 md:p-7 flex flex-col justify-between relative bg-gradient-to-br from-card to-primary/5 dark:to-amber-950/10">
                    <div>
                        {/* Header */}
                        <div className="flex items-start justify-between mb-4">
                            <div className="space-y-1">
                                <div className="flex items-center gap-2">
                                    <div className="px-2 py-0.5 rounded text-[10px] font-black uppercase tracking-widest bg-primary/10 text-primary dark:bg-primary/20 dark:text-primary">
                                        Kitap İncelemesi
                                    </div>
                                ...
                                <h3 className="text-lg sm:text-2xl md:text-3xl font-bold font-heading leading-tight text-foreground group-hover:text-primary transition-colors pt-1 md:pt-2 line-clamp-2 md:line-clamp-none">
                                    {bookTitle}
                                </h3>
