    ...
    return (
        <motion.div
            ...
            className={cn(
                ...
                "shadow-[6px_6px_0px_0px_rgba(245,158,11,1)] dark:shadow-[6px_6px_0px_0px_rgba(245,158,11,1)]", // Primary Amber shadow
                    ...
                    <div className="flex-1 p-2 sm:p-3 relative min-w-0">
                        <button
                            ...
                            className={cn(
                                ...
                                "rounded-xl",
                                isOpen && "border-primary shadow-[inset_2px_2px_0px_0px_rgba(0,0,0,0.1)]",
                        ...
                        <AnimatePresence>
                            {isOpen && (
                                ...
                                >
                                    <div className="p-0">
                                        <div className="px-4 py-3 border-b-2 border-foreground bg-primary text-primary-foreground">
                                        ...
                                        >
                                            <div className="relative w-10 h-10 bg-primary/10 dark:bg-primary/20 flex items-center justify-center text-primary border-2 border-primary shadow-[2px_2px_0px_0px_rgba(245,158,11,1)] group-hover:translate-x-[1px] group-hover:translate-y-[1px] group-hover:shadow-[1px_1px_0px_0px_rgba(245,158,11,1)] transition-all rounded-lg">
                                                <Book className="w-5 h-5" />
                                            </div>
                                            <div className="flex-1 min-w-0">
                                                <h4 className="font-black text-sm uppercase tracking-wide text-foreground group-hover:text-primary transition-colors truncate">Kitap İncelemesi</h4>
                                                <p className="text-[10px] text-muted-foreground leading-tight mt-0.5 font-bold truncate">Puanla ve İncele</p>
                                            </div>
                                            <Plus className="w-4 h-4 text-primary opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all flex-shrink-0" />
                                        </Link>
