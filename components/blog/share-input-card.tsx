    ...
    return (
        ...
        >
                ...
                <div className="flex gap-0">
                    ...
                    <div className="p-3 pr-2 hidden sm:block">
                        <Avatar className="w-10 h-10 sm:w-11 sm:h-11 border-2 border-foreground shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] rounded-none">
                            ...
                            <AvatarFallback className="bg-red-600 text-white font-black rounded-none">
                            ...
                            {isOpen && (
                                ...
                                >
                                    <div className="p-0">
                                        ...
                                        >
                                            <div className="relative w-10 h-10 bg-red-100 dark:bg-red-900/20 flex items-center justify-center text-red-600 border-2 border-red-600 shadow-[2px_2px_0px_0px_rgba(220,38,38,1)] group-hover:translate-x-[1px] group-hover:translate-y-[1px] group-hover:shadow-[1px_1px_0px_0px_rgba(220,38,38,1)] transition-all">
            ...
            <div className="px-4 py-2 bg-muted/20 border-t-2 border-foreground flex items-center gap-4 text-[10px] font-bold uppercase tracking-widest text-muted-foreground overflow-x-auto">
                <div className="flex items-center gap-2 hover:text-red-600 transition-colors cursor-pointer group">
                    <div className="w-1.5 h-1.5 bg-red-600 rounded-none group-hover:scale-150 transition-transform" />
                    <span>Blog</span>
                </div>
                <div className="w-0.5 h-3 bg-foreground/20" />
                <div className="flex items-center gap-2 hover:text-red-600 transition-colors cursor-pointer group">
                    <Book className="w-3 h-3 group-hover:text-red-600" />
                    <span>Medya</span>
                </div>
                <div className="w-0.5 h-3 bg-foreground/20" />
                <div className="flex items-center gap-2 hover:text-red-600 transition-colors cursor-pointer group">
                    <HelpCircle className="w-3 h-3 group-hover:text-red-600" />
                    <span>Soru</span>
                </div>
            </div>
        </motion.div>
