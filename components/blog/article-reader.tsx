                ...
                <div className={cn(
                    ...
                    <article className="article-body-wrapper block">
                        ...
                        <div className={cn(
                            ...
                            "prose-p:text-[16px] min-[390px]:prose-p:text-[16.5px] sm:prose-p:text-[17px] md:prose-p:text-[18px] prose-p:text-[#1a1a1a] dark:prose-p:text-[#e5e5e5] prose-p:leading-[1.76] sm:prose-p:leading-[1.82] prose-p:mb-5 sm:prose-p:mb-7 prose-p:font-[440]",
                            ...
                            // Lists
                            "prose-li:text-[16px] min-[390px]:prose-li:text-[16.5px] sm:prose-li:text-[17px] md:prose-li:text-[18px] prose-li:text-zinc-800 dark:prose-li:text-zinc-300 prose-li:leading-[1.74] sm:prose-li:leading-relaxed prose-li:marker:text-[#EAB308] prose-li:marker:font-black prose-li:font-[440]",
