                ...
                <div className="relative pt-16 sm:pt-20 pb-6 px-4 sm:px-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
                        ...
                        <div className="flex gap-2 sm:gap-2.5 overflow-x-auto no-scrollbar pb-2 sm:pb-0 -mx-4 px-4 sm:mx-0 sm:px-0">
                            {isOwnProfile ? (
                                <>
                                    <Link  href="/profil/duzenle" onClick={handleActionClick} className="flex-shrink-0">
                                    ...
                                    <Link  href="/mesajlar" onClick={handleActionClick} className="flex-shrink-0">
                                    ...
                                    {profile?.is_writer && (
                                        <Link  href="/yazar/yeni" onClick={handleActionClick} className="flex-shrink-0">
                                    ...
                                    {isAuthorMode && (
                                        <Link  href="/yazar-paneli" onClick={handleActionClick} className="flex-shrink-0">
                                    ...
                                    {isAdmin && (
                                        <>
                                            <Link  href="/yonetim/hikaye-olustur" onClick={handleActionClick} className="flex-shrink-0">
                                            ...
                                            <Link  href="/admin" onClick={handleActionClick} className="flex-shrink-0">
                                ...
                                <>
                                    ...
                                    <Link  href={`/mesajlar?to=${profile.id}`} onClick={handleActionClick} className="flex-shrink-0">
