            ...
            <aside className="space-y-4">
                ...
                <Tooltip>
                    <TooltipTrigger asChild>
                        <Card className="p-5 border-2 border-cyan-500/30 bg-gradient-to-br from-cyan-500/10 to-cyan-600/5 rounded-xl shadow-[3px_3px_0px_0px_rgba(6,182,212,0.2)] cursor-help hover:border-cyan-500/50 transition-colors">
